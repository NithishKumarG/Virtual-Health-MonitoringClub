...
<div id="header-bg">
	...
	<div id="header">
		<a href="#" class="style1"><font size="+3"><center><center> Virtual Health Club <br />Monitoring</center></font></a>
...
<div id="ourCompany-bg">
    ...
    &nbsp;&nbsp;<a href="pro_med_det.jsp"><font size="+1" color="red"><input type="image" src="images/icon-more.gif" width="25" height="25" >&nbsp;&nbsp;View Details</font></a><br><br>
    ...
    <tr bgcolor="#454545">
	 ...
	 <td class="paragraping2">Min Value</td>
	  <td class="paragraping2">Max Value</td> 
          <td class="paragraping2">Actual Value</td>
	 <td class="paragraping2">Description</td>
         <td class="paragraping2">DOC View</td>
...
psmt1=con.prepareStatement("select `mid`,`tid`,`titname`,`minvalue`,`maxvalue`,`tname`,`disc` from medication");
...
<tr>
		...
		<td class="paragraping"><%=rs.getString(7)%></td>
                <td class="paragraping"><a href="imageview.jsp?<%=rs.getString(1)%>">Image</a></td>
