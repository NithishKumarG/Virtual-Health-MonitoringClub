...
<div id="ourCompany-bg">
    ...
    <tr>
    <td><form>
    &nbsp;&nbsp;<a href="staproviderhome.jsp"><font size="+1" color="green"><input type="image" src="images/icon-more.gif" width="25" height="25" >&nbsp;&nbsp;View Details</font></a><br><br>
...
psmt=con.prepareStatement("select tok_id,uid,name,query,qdate from token");
...
psmt1=con1.prepareStatement("select name,email,mobile from signup where uid='"+uid+"'");
