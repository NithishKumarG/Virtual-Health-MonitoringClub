...
<div id="navigation-bg">
	...
	<div id="navigation">
		<ul class="mainMenu">
			<li><a href="providerhome.jsp" title="Home" class="selectMenu">CLIENT</a></li>
...
<div id="ourCompany-bg">
    ...
    <tr>
    <td><form>
     &nbsp;&nbsp;<a href="sta_user_ser.jsp"><font size="+1" color="green"><input type="image" src="images/search.png" width="25" height="25" >&nbsp;&nbsp;User Search</font></a><br><br>
...
psmt1=con.prepareStatement("select `mid`,`tid`,`titname`,`minvalue`,`maxvalue`,`disc` from medication");
...
<tr>
		...
		<td class="paragraping"><a href="viewsta.jsp?<%=rs.getString(1)%>">View</a></td>
	  </tr>	
