...
<div id="ourCompany-bg">
    ...
    <tr>
    <td><form>
    &nbsp;&nbsp;<a href="providerhome.jsp"><font size="+1" color="green"><input type="image" src="images/forum.jpg" width="25" height="25" >&nbsp;&nbsp; Home</font></a><br><br>
...
psmt1=con.prepareStatement("select pid,mid,postby,comments,date from relatedposts where mid='"+mid+"'");
