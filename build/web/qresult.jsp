...
psmt1=con.prepareStatement("select tok_id,uid,token,name,query,qdate from token where uid='"+uid+"'");
...
<tr>
		...
		<td class="paragraping"><%=rs.getString(6)%></td>
                <td class="paragraping"><font color="#FF3300"><strong><%=ABEEncryption.decrypt(rs.getString(3), "ABEEncryption")%></strong></font></td>
